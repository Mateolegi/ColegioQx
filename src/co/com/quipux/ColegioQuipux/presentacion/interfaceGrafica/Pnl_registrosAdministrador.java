 ...
 * @author Sebas
 */
public class Pnl_registrosAdministrador extends JPanel implements ActionListener{
    ...
    public Pnl_registrosAdministrador(Control_Instancias instancias,int width, int heigth) {
        this.width = width;
        this.heigth = heigth;
        pp=instancias;
