 ...
 * @author Sebas
 */
public class Pnl_consultarProfesor_Materia_Grupo extends JPanel implements ActionListener{
    ...
    public Pnl_consultarProfesor_Materia_Grupo(Control_Instancias instancia, int width,int height){
        this.width=width;
        this.height=height;
        pp=instancia;
