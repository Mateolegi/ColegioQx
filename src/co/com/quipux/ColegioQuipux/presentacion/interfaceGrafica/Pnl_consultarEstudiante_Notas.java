 ...
 * @author Sebas
 */
public class Pnl_consultarEstudiante_Notas extends JPanel implements ActionListener{
    ...
    public Pnl_consultarEstudiante_Notas(Control_Instancias instancia, int width,int height){
        this.width=width;
        this.height=height;
        pp=instancia;
